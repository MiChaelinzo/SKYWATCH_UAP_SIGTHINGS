  ...
  return (
    <div className="py-10">
      <div className="grid place-items-center">
        ...
        <h2 className="text-xl text-center text-white font-tektur relative">Click the page and use your keyboard to scroll to right for more comprehensive information!</h2>
