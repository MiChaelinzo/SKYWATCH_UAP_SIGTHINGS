...
export default function Page() {
  ...
  return (
    <div className="py-10">
      ...
      <h2 className="text-xl text-center text-white font-tektur relative"> Search by shape and use your mouse or keyboard to scroll to the right for more information! </h2>
