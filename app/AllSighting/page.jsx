  ...
  return (
    <div className="py-10">
      <div className="grid place-items-center">
       ...
       <h2 className='text-base text-center text-white font-tektur relative'> Add Sightings is added here. Search by description and use your mouse/keyboard/touchpad to scroll to the right for more information.</h2>
