  ...
  return (
    <div className="py-10">
      <div className="grid place-items-center">
        ...
        <h2 className="text-xl text-center text-white font-tektur relative"> CTRL + F for search. Click the page and use your mouse/keyboard to scroll to right for more information!</h2>
